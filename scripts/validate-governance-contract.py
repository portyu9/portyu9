...
profile evidence generation/identity/attestation/publication, fresh-run concurrency,
and artifact-only publish behavior. The companion .github/GOVERNANCE.md records the
...
def main() -> int:
    try:
        ...
        print(
            ...
            "is mandatory, Signal Field Evidence ID is generated/validated before signing, third-party generation "
            "has neither write nor signing authority, attestation is isolated, and publication revalidates the same identity."
        )
        return 0
