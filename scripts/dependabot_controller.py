...
def derive_codeql_files(
    *,
    ...
    extension_ids = {"action-provenance-witness", "bot-pr-user-approval", "capability-admission", "codeql-autofix", "dependabot-controller", "ruleset-drift-sentinel", "ruleset-reconciler"}
    base_workflows = [
