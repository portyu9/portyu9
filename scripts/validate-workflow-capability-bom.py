...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1084 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "f01fd84315ff94560984e7b96817676358758969"
    source_sha = "7e5e8a777fb60419cfc6ab8c582e6b69babe8a4f"
    expected_tree = "31b4c4a82c331856fcb5f84938e7ccb848dfa416"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1084 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
