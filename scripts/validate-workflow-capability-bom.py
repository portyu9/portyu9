#!/usr/bin/env python3
"""Diagnostic: emit authoritative event-driven Dependabot liveness capability tuple."""
...
MAIN_SHA = "3744cddb26c04d1923a9060a1c00ac5f1574b9ed"
CANDIDATE_SHA = "83fd4fb6ff1f21e7e18b9f7fb399b013fde87551"
CANDIDATE_TREE_SHA = "1ece253f6b188d7f3324e0284bddbb7f9f416d04"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-liveness-tuple-") as tmp:
        root = Path(tmp)
