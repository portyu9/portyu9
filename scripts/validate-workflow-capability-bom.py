#!/usr/bin/env python3
"""Diagnostic: emit authoritative Dependabot author-association TCB tuple."""
...
MAIN_SHA = "8108951433bed9de59a9a8caa0978b39073cb076"
CANDIDATE_SHA = "9346862450444f1c62b72300fe885b589cb7e0e4"
CANDIDATE_TREE_SHA = "29c3799391ac2f539b6d9b35bfcabc5c9b5c2716"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-author-association-tuple-") as tmp:
        root = Path(tmp)
