...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1062 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "0e3229419381b977fa62aa1b12f59d257c5b3741"
    source_sha = "35cbbb4e635d59035873e2be0d24ecb0f3961ef4"
    expected_tree = "b495069d47616324d44ab1cb70f57962876f149f"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1062 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
