...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #839 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "05dd1410f2a3b6e9b65f871d81e00f77868af9dc"
    source_sha = "f2b1811e59ff356b246c34c050e519a33b721270"
