#!/usr/bin/env python3
"""Diagnostic: emit authoritative Dependabot workflow-approval capability tuple."""
...
MAIN_SHA = "03e963dde6df2281c4dc1a3f118a809ac3664f1f"
CANDIDATE_SHA = "d35cf0396dfd875223e6dac84a869520107bce99"
CANDIDATE_TREE_SHA = "b979f094a165987247b4ea3289952db8d354c242"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-workflow-approval-tuple-") as tmp:
        root = Path(tmp)
