...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #966 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "8fe5962e53b449dab60ac57a0d0f0680f7bc5140"
    source_sha = "9847c7a74d481f86248e3006f0ce64ac33dd7727"
