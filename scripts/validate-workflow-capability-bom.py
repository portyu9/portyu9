...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit frozen #983 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "43d2f22f918e96165b3ebf51fcc95b494237ab5f"
    source_sha = "89c5c5652da5da06547e0435b4ebaebc9b2d30bc"
