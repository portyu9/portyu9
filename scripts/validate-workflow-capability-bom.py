#!/usr/bin/env python3
"""Diagnostic: emit authoritative Dependabot admission metadata-persistence tuple."""
...
MAIN_SHA = "82cdb0b2cc50925b61df123e1cca2f2c09ae4636"
CANDIDATE_SHA = "323164df151dcc1268bee9ff116c9d37ed189e62"
CANDIDATE_TREE_SHA = "dcd30172759a3877c4097952f3dc41456d4bbac2"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-admission-metadata-tuple-") as tmp:
        root = Path(tmp)
