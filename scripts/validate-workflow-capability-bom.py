...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1105 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "eae4f9dda34c4b38a5919a36d698a7bea749a3a0"
    source_sha = "b1282694533c93e73273bcec9f97c397d90e6090"
    expected_tree = "303d2e36dc95a17ba46423c3e67f566d37d5d6e9"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1105 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
