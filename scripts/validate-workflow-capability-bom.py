#!/usr/bin/env python3
"""Diagnostic: emit canonical full-PR binder Dependabot controller BOM extension."""
...
def main() -> int:
    ...
    print("DEPENDABOT_BINDER_LENGTH=" + str(len(raw)))
    print("DEPENDABOT_BINDER_GIT_BLOB_SHA=" + git_blob_sha(raw))
    print("DEPENDABOT_BINDER_BASE64=" + base64.b64encode(raw).decode("ascii"))
    print("ERROR: diagnostic intentionally stops after canonical binder extension emission", file=sys.stderr)
    return 1
