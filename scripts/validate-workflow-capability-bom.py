...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #796 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "e3f83eb81d8d4924dce34682a70f9b0fa2a093dd"
    source_sha = "8d898b9dedbdda0022bcc06c4c05e381dc46ebb7"
