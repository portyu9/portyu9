...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #765 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "e05ef24459b150367ee414cc9d2016db3007cfc3"
    source_sha = "647a88a0c77d50bb552d35360c8a40c908eabf29"
