...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1096 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "e8d3df197ca2fbb3de8af912b6bf5c91957e1b50"
    source_sha = "c34cf638cc38960147095aea21e93323daaeb099"
    expected_tree = "178d811a20d0b710c526c47933bff4b37c5bba70"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1096 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
