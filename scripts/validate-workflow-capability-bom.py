#!/usr/bin/env python3
"""Diagnostic: emit authoritative GitHub-native bot approval capability tuple."""
...
CANDIDATE_SHA = "3ed7027d39c802027590a19ab3c4b6ad165d08c1"
CANDIDATE_TREE_SHA = "cd8529fe5bfa098b5b82deeade61f2692d0d078b"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="github-native-bot-approval-tuple-") as tmp:
        root = Path(tmp)
