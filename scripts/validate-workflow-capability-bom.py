#!/usr/bin/env python3
"""Diagnostic: emit authoritative PR-native Dependabot admission capability tuple."""
...
MAIN_SHA = "e1882d0ca7f4b6a43903f1526e3c0ffb84711653"
CANDIDATE_SHA = "2fa7ae1bc0710d619731fbb73688909ac73b367d"
CANDIDATE_TREE_SHA = "7aae6be8873dc5ac4f060b0d98546d16775d1186"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-pr-native-admission-tuple-") as tmp:
        root = Path(tmp)
