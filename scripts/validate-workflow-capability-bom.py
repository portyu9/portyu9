...
MAIN_SHA = "8cfadfba231aad98bb01d231985f324e85eae0d8"
CANDIDATE_SHA = "d61a9ac10d726e74fec1164368b923f332a8ec5d"
CANDIDATE_TREE_SHA = "6f70a2665714109104e65b0729d59529366e8478"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-duplicate-convergence-tuple-") as tmp:
        root = Path(tmp)
