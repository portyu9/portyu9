...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1100 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "e6a1e36d7385693302a212e8cd7206762aebbdad"
    source_sha = "a73918c988c84ae5991d00e4bf2c489e499eb322"
    expected_tree = "a3b6a0ecaa12ac5125f52dbbb2b24b28b465f40a"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1100 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
