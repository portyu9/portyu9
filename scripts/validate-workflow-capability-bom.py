...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact corrected frozen #844 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "fe579c723bc3afe3b4407f434990e396e0019350"
    source_sha = "3213740c3ca852d23bdf22b10a9501ad97725739"
