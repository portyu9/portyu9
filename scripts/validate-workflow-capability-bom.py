...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #974 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "873947da7ae588050a5505420f0979e05d3427d5"
    source_sha = "92d995209982d2442f512cf839125d78feaab407"
