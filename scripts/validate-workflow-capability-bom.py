...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #1040 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "1cb9e6d75b2fe6af59750fc94594367becbe0b1c"
    source_sha = "5fc5b6ea629fd2f2ff4df88d847f886a7b1fe6e3"
    expected_tree_sha = "8a890dbc7f9a4cb494cbbad00482a8eb34636d19"
