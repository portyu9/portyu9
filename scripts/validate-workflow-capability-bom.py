...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #890 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "fec673db412d9f8470adaf16edc6751a5c99bae7"
    source_sha = "90d695ea80cc2c0ebbda68671f6f1565310f6298"
