...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1071 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "5c4a7e2f73ff899c62b92ce2aaf4877e88b61db4"
    source_sha = "ec31e2da224366dab3068cbcae2fcb47fffe1fe7"
    expected_tree = "1d355929ef814d5c40d6bf4637197980b9a473b0"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1071 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
