...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #946 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "afdcffbe7830c3a9b7992995672d348eae39f301"
    source_sha = "1725055cb3215c23f7778442410574cc13610a70"
