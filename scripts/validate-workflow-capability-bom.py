...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #1036 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "b2b2f401ef15f744d9a32d13ec94f89ea32ead68"
    source_sha = "a3edb71bfd99183d126aa9839ea1f375fd146a83"
    expected_tree_sha = "47072914f5b86ecbe49685e1b01f900d4216d8c8"
