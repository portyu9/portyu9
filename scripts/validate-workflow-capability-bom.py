...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #940 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "3ee463bbf20fd36d23a6720f73d66a5557864f70"
    source_sha = "1a55a01ad41ddd0491f041e391ceee3aabf91cb4"
