...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #1049 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "8e891e65d7aba8668d2d0b14724934df68efcbe6"
    source_sha = "e9e422bc41e6c4635249f476470f08db51590c3b"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(
            len(candidate_tree_sha) == 40 and all(ch in "0123456789abcdef" for ch in candidate_tree_sha),
            "trusted diagnostic frozen candidate tree identity is malformed",
        )
