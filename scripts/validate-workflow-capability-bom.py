...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #956 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "6f9125ca6a7ce464975211b137ceef0bfa85fb30"
    source_sha = "cefb875cfb70f0160ad465f4840dbdce8c06a62d"
