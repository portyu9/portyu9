...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1089 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "c449723e6a4b4aba7e8416203889aeef136ecc7e"
    source_sha = "333ad11c2454cad7a3d11b2adf9051634a9972c5"
    expected_tree = "d870c59320ce8d19db88c45c94a4659350fc71ee"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1089 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
