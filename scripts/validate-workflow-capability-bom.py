...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1111 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "f95fefbe03b9fb6f01eea979db6069eb8fe37008"
    source_sha = "f544712497be2b6a0994039c3f56f98189f2eeaa"
    expected_tree = "0aed5aaf5c8fc21302bd3171535de78447001192"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1111 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
