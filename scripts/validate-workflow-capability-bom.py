...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #1044 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "74d3d9e87227e5845636890b79ee2ad736be2e58"
    source_sha = "69d8ea7e565ebac8679160d9ba50c0056011f9c3"
    expected_tree_sha = "02a948a4beaf63f317ce7ad6b3a3cf0902b36578"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(
            candidate_tree_sha == expected_tree_sha,
            "trusted diagnostic frozen candidate tree identity changed",
        )
