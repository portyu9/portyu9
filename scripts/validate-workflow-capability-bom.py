#!/usr/bin/env python3
"""Diagnostic: emit authoritative Dependabot duplicate-check convergence capability tuple."""
...
MAIN_SHA = "fa97f626a0a4b73f33c8a136664caf93e0b581e0"
CANDIDATE_SHA = "07b82138e579d0e04753259eb9949d23f198274e"
CANDIDATE_TREE_SHA = "ecef0b23aba374455c9bca70b45488fdc37b862a"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-duplicate-check-convergence-tuple-") as tmp:
        root = Path(tmp)
