...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1068 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "86975656f797f1ef12a9e3a0caab9a5f361835b4"
    source_sha = "d3d6ad190558a8c29b26f7b8dca5c4ddf10d10cb"
    expected_tree = "484590a5f8a98c0e698006299958638649bf98df"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        require(tree == expected_tree, "frozen #1068 candidate tree identity changed")
        code = (
            "from pathlib import Path\n"
            "import sys\n"
