...
def validate_snapshot() -> tuple[int, int]:
    ...
    require(len(workflows) == 10, f"Workflow Capability BOM workflow count changed: {len(workflows)}")
...
def trusted_diagnostic() -> None:
    """Disposable carrier: reproduce trusted-main rejection and print only the exact authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "3eb4751c37be9aa7a77e4473cf29599591760371"
