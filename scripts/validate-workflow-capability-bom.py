...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #1000 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "bc91f0292c269341168b772ce053a161329c8ceb"
    source_sha = "a125c32d17d3321a188669cf5651c971ba9edaa7"
