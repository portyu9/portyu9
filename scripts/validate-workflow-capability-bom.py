...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #829 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "dfc2c722547c3a535416035fd743d1cd364af2c9"
    source_sha = "b4d0b6ffc3aba5bb329fd8b525715a1d9410aa60"
