...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit the exact frozen #1144 prior-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "ac807d0486f628d972ec8619a35a8b3118a63d69"
    source_sha = "1468ecaf28787a4c748a454c674e61cc12c066fc"
    ...
    with tempfile.TemporaryDirectory(prefix="trusted-admission-") as temporary:
        ...
        code = (
            ...
            "try:\n"
            "    result=admission.evaluate(candidate, candidate_tree_sha=tree)\n"
            "except ValueError as exc:\n"
            "    print('TRUSTED-ADMISSION-DIAGNOSTIC-TREE:', tree)\n"
            "    print('TRUSTED-ADMISSION-DIAGNOSTIC:', exc)\n"
            "    raise SystemExit(0)\n"
            "print('TRUSTED-ADMISSION-DIAGNOSTIC-TREE:', tree)\n"
            "print('TRUSTED-ADMISSION-DIAGNOSTIC-RESULT:', result)\n"
        )
        subprocess.run(
