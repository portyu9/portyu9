...
def trusted_diagnostic() -> None:
    """Disposable carrier: emit exact frozen #1054 trusted-authorization tuple."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "4772ca1468aede8867673ad6a4ab9a0e0b0f017b"
    source_sha = "e2c8ecd8d7c826a3faae8d7dba0c6264f67fb71c"
