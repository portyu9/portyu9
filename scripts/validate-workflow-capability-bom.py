...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #824 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return
    base_sha = "3f4ecf8932fe86431e3aa8660503607b73c1d9c7"
    source_sha = "8959d1734700ab1a517096d8fd6e01124301f409"
