#!/usr/bin/env python3
"""Diagnostic: emit authoritative Dependabot terminal-convergence capability tuple."""
...
MAIN_SHA = "5f5bb26ff781032c1faf1c9ec0ed72b67bed8d96"
CANDIDATE_SHA = "77fca3e26a570b3934d52f21fad6360af104afa0"
CANDIDATE_TREE_SHA = "59e51b8f47ff192823e00fea6574161b8df86b94"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="dependabot-terminal-convergence-tuple-") as tmp:
        root = Path(tmp)
