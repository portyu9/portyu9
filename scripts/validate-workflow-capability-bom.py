#!/usr/bin/env python3
"""Diagnostic: emit authoritative bot PR review liveness capability tuple."""
...
MAIN_SHA = "0e41a22837e32cf44ed9bff5e51d2c15fce34cbe"
CANDIDATE_SHA = "b1485627a22498ad398901f1fbdb2b5af6a8565c"
CANDIDATE_TREE_SHA = "51eaf5453736dd870b0a162324ea77206fef5dd0"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="bot-review-liveness-tuple-") as tmp:
        root = Path(tmp)
