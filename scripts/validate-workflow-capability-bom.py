...
def trusted_diagnostic() -> None:
    """Disposable carrier: evaluate exact frozen #850 with exact accepted-main admission code."""
    if os.environ.get("GITHUB_ACTIONS") != "true":
        return

    base_sha = "1b77a5f9353c88b866a4259c9455a608908e101c"
    source_sha = "96e18b11f63ea0e8cb0e2448181438a723589b9b"
