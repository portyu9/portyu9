        ...
        for helper_current, helper_replacement, label in list_helper_mutations:
            ...
            try:
                ...
                require(
                    ...
                    or "base/head repository identity" in str(exc)
                    or "base/head SHA identity" in str(exc),
...
if __name__ == "__main__":
    raise SystemExit(main())
        ...
        and spotlight.count("validate_spotlight_reviewer_request_response() {") == 1
        and spotlight.count('validate_spotlight_reviewer_request_response "        "Spotlight PR response schema/call cardinality changed",
    )
...
if __name__ == "__main__":
    raise SystemExit(main())
        ...
        and spotlight.count("validate_spotlight_pull_list_item() {") == 1
        and spotlight.count('validate_spotlight_pull_list_item "        "Spotlight PR response schema/call cardinality changed",
    )
