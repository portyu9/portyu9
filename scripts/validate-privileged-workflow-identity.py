...
def validate_spotlight_pr_response_evidence(
    ...
    require(
        ...
        and spotlight.count('validate_spotlight_open_pr_object "
    if run_self_test:
...
if __name__ == "__main__":
    raise SystemExit(main())
        ...
        and spotlight.count('validate_spotlight_reviewer_request_response "
    if run_self_test:
        weakened = spotlight.replace(
            post_review_schema, 'true # adversarially removed post-review PR schema', 1
        )
